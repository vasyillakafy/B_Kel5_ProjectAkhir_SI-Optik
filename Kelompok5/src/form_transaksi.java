...
public class form_transaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnedit.setBounds(370, 350, 61, 31);
        ...
        btndelete.setBounds(450, 350, 79, 31);
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        Object id_petugas = jcombo_idpetugas.getSelectedItem().toString();
        Object id_konsumen = jcombo_idkonsumen.getSelectedItem().toString();
        Object id_resep = jcombo_idresep.getSelectedItem().toString();
        Object id_kacamata = jcombo_idkacamata.getSelectedItem().toString();
        Object cara_pembelian = jcombo_carapembelian.getSelectedItem().toString();
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        try{
            Statement statement = (Statement) connect.GetConnection().createStatement();
            statement.executeUpdate("UPDATE transaksi SET ID_Petugas ='" + id_petugas + "',ID_Konsumen='" + id_konsumen +
                    "',ID_Resep ='" + id_resep + "',ID_kacamata ='" + id_kacamata + "',Cara_pembelian ='" + cara_pembelian +
                    "',Tgl_kirim ='" + tanggal_kirim + "',Harga ='" + harga + "',DP='" + dp + "',Angs1='" + angs1 + 
                    "',Angs2='" + angs2 + "',Angs3='" + angs3 + "'where ID_kacamata = '" + id_kacamata + "'");
            statement.close();
